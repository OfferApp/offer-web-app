                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane active" id="tab_1_3">
                                                                <form action="{{route('setPassword')}}" method="post">
                                                                  {{ csrf_field() }}
                                                                    <div class="form-group{{ $currentPassword ? ' has-error' : '' }}" id="currentPassword">
                                                                    ...
                                                                    <div class="form-group{{ $errors->has('newPassword') ? ' has-error' : '' }}" id="newPassword">
                                                                    ...
                                                                    <div class="form-group{{ $errors->has('confirmPassword') ? ' has-error' : '' }}" id="confirmPassword">
