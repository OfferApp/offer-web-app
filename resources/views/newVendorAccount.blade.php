                ...
                <div class="page-head">
                    <div class="container">
                        ...
                        <div class="page-title">
                            <h1>New Vendor Profile | Account
                                <small>vendor account page</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
                        <!-- BEGIN PAGE TOOLBAR -->
                                                ...
                                                <div class="portlet light ">
                                                    <div class="portlet-title tabbable-line">
                                                        ...
                                                        <ul class="nav nav-tabs">
                                                            ...
                                                            <li>
                                                                <a href="#tab_1_4" data-toggle="tab">Location Settings</a>
                                                            </li>
                                                        </ul>
                                                    </div>
